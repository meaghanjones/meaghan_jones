...
$(document).ready(function (){
  $("#meglish").click(
    function () {
      $("#projectinfo").text('Meaghan is a great professional and it was fun to work with her. She asked insightful questions to better understand my expectations. She delivered exactly what I requested and even ahead of schedule. I highly recommend her!');
    }
  )
});
